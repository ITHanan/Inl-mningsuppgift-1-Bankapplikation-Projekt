...
--    accountID INT PRIMARY KEY, -- Primary Key
...
--    transactionID INT PRIMARY KEY, -- Primary Key
...
--MED Index 
--Databasen använder indexet för att snabbt hitta posten.
--CREATE INDEX IDX_CustomerID20 ON Customers (customerID);
